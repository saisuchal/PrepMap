    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-primary text-primary-foreground shadow-[0_4px_14px_0_hsl(var(--primary)/0.25)] hover:shadow-[0_6px_20px_0_hsl(var(--primary)/0.3)] hover:-translate-y-0.5": variant === "default",
